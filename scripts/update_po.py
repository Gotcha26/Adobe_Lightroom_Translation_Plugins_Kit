...
def parse_po(filepath: Path) -> Tuple[POEntry, Dict[str, POEntry]]:
...
def merge_po_with_pot(po_header: POEntry, po_entries: Dict[str, POEntry],
                       pot_header: POEntry, pot_entries: Dict[str, POEntry],
