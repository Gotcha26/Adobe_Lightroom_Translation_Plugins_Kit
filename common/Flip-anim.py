...
def airport_display_intro(text="GOTCHA Solutions", duration=5, line_width=80, color="yellow", bg_color="default", fade_duration=1.0, framerate=20, line_symbol="_", final_pause=1.0):
    """
