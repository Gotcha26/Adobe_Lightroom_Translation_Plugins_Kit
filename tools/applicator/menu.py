...
from core.paths import find_latest_tool_output, validate_plugin_path, get_i18n_dir
...
class ApplicatorMenu:
    ...
    def print_config(self):
        ...
        if self.extraction_dir:
            if os.path.isdir(self.extraction_dir):
                ...
                print(c.config_line("2. " + _("Extraction"), f"{display_path} {c.VALUE}[{c.RESET}{status}{c.VALUE}]{c.RESET}"))
            else:
                display_path = self._shorten_extraction_path(self.extraction_dir)
    ...
    def print_menu(self):
        ...
        print(c.menu_option(_("1-4"), _("Modifier une option")))
    ...
    def input_dry_run(self):
        ...
        current = "O_(" if self.dry_run else ")N"
    ...
    def input_backup(self):
        ...
        current = "O_(" if self.create_backup else ")N"
